  ...
  def selectors = []
	devices.each { device ->
        ...
        // Tunable Active Light
			...
			log.debug "Identified: ${device.name} Hive Light Tunable"
            def value = "${device.name} Hive Light Tunable"
                def key = device.id
        ...
        //Colour Bulb
			...
			log.debug "Identified: ${device.name} Hive Colour Bulb"
            def value = "${device.name} Hive Colour Bulb"
                def key = device.id

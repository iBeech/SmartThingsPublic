...
def selectDevicePAGE() {
    ...
    section("Select your devices:") {
            ...
            input "selectedActivePlug", "enum", image: "https://images-na.ssl-images-amazon.com/images/I/51bMGJZuR5L._SL1467_.jpg", required:false, title:"Select Plugs \n(${state.hiveActivePlugDevices.size() ?: 0} found)", multiple:true, options:state.hiveActivePlugDevices
...
def addMultiColourBulb() {
	...
	selectedMultiColourBulb.each { device ->
        ...
        if (!childDevice) {
    		log.debug "Adding Tunable Bulb ${device}: ${state.hiveMultiColourBulbDevices[device]}"
